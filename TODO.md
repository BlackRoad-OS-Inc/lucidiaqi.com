...
> Active tasks for Lucidia QI

## [RC] Priority 1 — Ship Now

- [ ] [RC] Deploy live website to lucidiaqi.com via Gematria/Caddy
...
- [ ] [RC] Write product landing copy for: QI Agents, Trinary Router, Amundson Decision Engine
